import { z } from "zod";
import { isAllowedAssetSource } from "./assetSourceSchema.js";
...
export const aiOperationSchema = z.discriminatedUnion("action", [
  ...
  z.object({
    ...
    elementId: z.string().min(1),
    newElementId: z.string().min(1).max(100),
    changes: elementChangesSchema.optional(),
  }),
  z.object({
